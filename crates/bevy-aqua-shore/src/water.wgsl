...
// Must match the 16-cell startup texture generated by bevy-aqua-shore.
const CAUSTIC_CELLS_PER_TILE: f32 = 16.0;
// Air / water refractive indices for the flat-interface incoming sun path.
const CAUSTIC_AIR_TO_WATER_ETA: f32 = 1.0 / 1.333;
...
// River-wave synthesis lives in bevy_aqua_core::river (shared with the
// wave-query pass).
...
fn caustic_bed_radiance(
    ...
    let cos_transmitted = sqrt(1.0 - CAUSTIC_AIR_TO_WATER_ETA
        * CAUSTIC_AIR_TO_WATER_ETA * (1.0 - cos_incident * cos_incident));
    let incoming_path = water_depth / cos_transmitted;
