...
fn wgsl_transmission_routes_modes_before_sampling_and_reuses_foam_depth() {
    ...
    assert_in_order(
        ...
        &[
            ...
            "if mode == DEBUG_MODE_BEAUTY { let body = beauty_transmission(in, normal, to_view, primary, shared_depth_path, source_slot,); return TransmissionState(body, vec4(0.0), false); }",
